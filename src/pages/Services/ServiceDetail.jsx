...
import { FaArrowLeft, FaCalendarAlt, FaGraduationCap, FaExternalLinkAlt, FaTag } from 'react-icons/fa';
...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    const fetchCertificate = async () => {
      try {
        setLoading(true);
        const response = await axios.get(`${BASE_URL}/api/certifications/public/${id}`);
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                <h2 className="text-2xl font-bold mb-4 text-gray-800">Get Certified</h2>
            ...
            <div className="space-y-8">
                      ...
                      <p className="font-medium text-gray-800">
                        ...
                        {certificate.durationInMonths >= 12 && (
                          <span className="text-gray-600 ml-1">
                            ({Math.floor(certificate.durationInMonths / 12)} year
              ...
              >
                <h2 className="text-2xl font-bold mb-4 text-blue-700">Your Badge</h2>
